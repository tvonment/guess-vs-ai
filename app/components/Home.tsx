    ...
    return (
        <main className="mt-4 shadow-lg w-full">
            ...
            <div className="flex p-10 pt-3 pb-3 flex-col items-center text-center">
                ...
                <h3 className="text-white text-lg md:text-2xl mb-2">Ask your Questions carefully, if the answer is a <strong>{Answer.YES}</strong> or <strong>{Answer.PROBABLY_YES}</strong> you get another turn.</h3>
